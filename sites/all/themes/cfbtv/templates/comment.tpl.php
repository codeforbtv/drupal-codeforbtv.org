 ...
 * @ingroup themeable
 */
$dateDay = format_date($comment->created, 'custom', "M d"); 
$dateSuffix = format_date($comment->created, 'custom', "S");
$dateYear = format_date($comment->created, 'custom', "Y");
$dateTime = format_date($comment->created, 'custom', "gia");
...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="comment__intro">
    ...
    <span class="comment__intro--date">– <?php print strtoupper("$dateDay") . "<sup>$dateSuffix</sup> $dateYear"; ?></span>
  </div>
